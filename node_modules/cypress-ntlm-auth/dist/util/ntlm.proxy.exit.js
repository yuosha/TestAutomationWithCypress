    ...
    quitIfRunning() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this._portsFileService.exists()) {
                ...
                yield this.sendQuitCommand(portsFile.configApiUrl);
            }
            else {
...
exports.NtlmProxyExit = NtlmProxyExit;
