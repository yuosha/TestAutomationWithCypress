...
describe('Logs in, creates joint customer, unmetered object and a new connection contract (saved)', () => {
    ...
    it('should create joint customer, unmetered object new connection contract (saved)', () => {
