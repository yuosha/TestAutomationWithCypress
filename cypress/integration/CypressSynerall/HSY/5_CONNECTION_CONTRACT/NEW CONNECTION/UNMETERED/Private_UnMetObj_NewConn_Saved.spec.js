...
describe('Logs in, creates private customer, unmetered object and a new connection contract (saved)', () => {
    ...
    it('should create private customer, unmetered object and a new connection contract (saved)', () => {
