...
describe('Logs in, creates private customer, unmetered object and a new connection contract (connected)', () => {
    ...
    it('Creates private customer, unmetered object and a new connection contract (connected)', () => {
