...
describe('Logs in, creates private customer, metered object and a new connection contract (connected)', () => {
    ...
    it('Creates private customer, metered object and a new connection contract (connected)', () => {
