...
describe('Logs in, adds private customer, creates local metered object and saves the customer as object owner', () => {
    ...
    it('Creates private customer, local metered object and save the customer as an object owner', () => {
