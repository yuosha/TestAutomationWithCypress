...
describe('Logs in, creates private customer, local metered object with owner and a network contract (saved)', () => {
    ...
    it('should create private customer, local metered object and a network contract(saved)', () => {
