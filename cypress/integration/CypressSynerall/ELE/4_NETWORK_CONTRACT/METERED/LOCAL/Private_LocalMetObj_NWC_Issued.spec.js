...
describe('Logs in, adds private customer, creates local metered object with owner, and network contract (issued)', () => {
    ...
    it('should create private customer, local metered object and network contract (issued)', () => {
