...
describe('Logs in, adds joint customer, metered object with owner, new connected connection contract, new joint owner, and saved conn change contract', () => {
    ...
    it('Creates joint customer, metered object and new connected connection contract, new joint owner, and Connection change contract (saved)', () => {
