...
describe('Logs in, adds joint customer, creates metered object with owner and a new saved connection contract', () => {
    ...
    it('should create joint customer, metered object with owner and a new saved connection contract', () => {
