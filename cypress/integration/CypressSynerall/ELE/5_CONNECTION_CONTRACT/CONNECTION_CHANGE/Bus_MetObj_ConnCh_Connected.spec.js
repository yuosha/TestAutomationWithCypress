...
describe('Logs in, adds bus. customer, creates metered object with owner and a new connected connection contract', () => {
    ...
    it('creates bus. customer, metered object and a new connected connection contract', () => {
