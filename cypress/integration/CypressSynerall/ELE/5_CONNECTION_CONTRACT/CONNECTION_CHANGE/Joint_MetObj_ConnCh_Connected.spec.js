...
describe('Logs in, adds joint customer, metered object with owner, new connected connection contract and connection change contract (connected)', () => {
    ...
    it('creates joint customer, metered object, new connected connection contract and connection change contract (connected)', () => {
