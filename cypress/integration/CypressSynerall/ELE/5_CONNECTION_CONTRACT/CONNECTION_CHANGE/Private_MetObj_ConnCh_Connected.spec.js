...
describe('Logs in, adds private customer, metered object with owner, new connected connection contract and connection change contract (connected)', () => {
    ...
    it('creates private customer, metered object, new connected connection contract and connection change contract (connected)', () => {
        ...
        connChangeContractPage.createConnChangeContractConnected()
    })
})